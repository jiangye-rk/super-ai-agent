...
| 🔧 **JiangManus 智能体** | 基于 **ReAct 模式** 的自主规划智能体 | 工具调用、多步推理、MCP 协议支持 |
...
> 2. JiangManus 智能体界面 (`jiang-ai-agent-frontend/src/views/ManusChat.vue`)
> 3. API 文档界面 (Swagger UI)

```markdown
![恋爱大师界面](./docs/images/love-chat.png)
![JiangManus 界面](./docs/images/manus-chat.png)
```
